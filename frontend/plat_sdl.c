...
#if SDL_MAJOR_VERSION == 2
    plat_sdl_present(plat_sdl_screen->pixels, psx_w, psx_h, rgb888 ? 24 : 16,
      aspect_ratio == ASPECT_4_3, filter_mode == FILTER_ON);
#else
...
void plat_video_menu_end(void)
{
  ...
  if (plat_sdl_gl_active) {
    ...
    plat_sdl_present(plat_sdl_screen->pixels, g_menuscreen_w, g_menuscreen_h, 16, 1, 0);
